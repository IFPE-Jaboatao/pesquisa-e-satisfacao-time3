          ...
          {sucesso === "true" ? (
            <Card className="text-center p-8 shadow-sm max-w-md mx-auto mt-12" style={{ backgroundColor: 'var(--white)', borderColor: 'var(--light-color)' }}>
              <div className="flex flex-col items-center justify-center space-y-4">
                <div className="w-16 h-16 rounded-full flex items-center justify-center shadow-sm" style={{ backgroundColor: 'rgba(136, 221, 57, 0.15)', color: 'var(--highlight)' }}>
            ...
            <form action={lidarComEnvio} className="w-full max-w-3xl mx-auto space-y-6">
              ...
              <div className="flex justify-end">
                <Button type="submit" size="md" className="text-white font-medium rounded-lg animate-none" style={{ backgroundColor: 'var(--edit-blue)' }}>Enviar Respostas</Button>
              </div>
            </form>
          )}
        </div>
          ...
          <Card style={{ backgroundColor: 'var(--white)', borderColor: 'var(--light-color)' }}>
            ...
            <div className="space-y-3 mt-4 max-h-60 overflow-y-auto pr-2">
              {comentariosTexto.map((comentario, index) => (
                <div key={index} className="p-3 border-l-4 rounded text-sm text-gray-700 font-medium shadow-sm" style={{ backgroundColor: 'var(--light-color)', borderColor: 'var(--edit-blue)' }}>
                  &quot;{comentario}&quot;
                </div>
              ))}
            </div>
