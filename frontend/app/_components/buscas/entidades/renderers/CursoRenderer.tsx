...
export default function CursoRenderer({
    curso,
    campi
    }: Props) { 
        ...
        // chama a action pra deletar o curso
        async function handleDelete() {
            const res = await deleteCursoAction({id: curso.id});
        ...
        return(
            <div className="bg-white shadow-2xl p-5 rounded max-h-max justify-center flex flex-col flex-1 lg:ml-20 lg:mr-20">
                ...
                <CursoPage curso={curso} /> : 

                <CursoForm curso={curso} campi={campi} />}
