...
export default function DisciplinaRenderer({
    disciplina,
    cursos
    }: Props) { 
        ...
        // chama a action pra deletar a disciplina
        async function handleDelete() {
            const res = await deleteDisciplinaAction({id: disciplina.id});
        ...
        return(
            <div className="bg-white shadow-2xl p-5 rounded max-h-max justify-center flex flex-col flex-1 lg:ml-20 lg:mr-20">
                ...
                <DisciplinaPage disciplina={disciplina} /> : 

                <DisciplinaForm disciplina={disciplina} cursos={cursos} />}
