...
export default function TurmaRenderer({
    turma,
    disciplinas,
    periodos,
    docentes
        ...
        // chama a action pra deletar a turma
        async function handleDelete() {
            const res = await deleteTurmaAction({id: turma.id});
        ...
        return(
            <div className="bg-white shadow-2xl p-5 rounded max-h-max justify-center flex flex-col flex-1 lg:ml-20 lg:mr-20">
                ...
                <TurmaPage turma={turma} /> : 

                <TurmaForm turma={turma} disciplinas={disciplinas} periodos={periodos} docentes={docentes} />}
